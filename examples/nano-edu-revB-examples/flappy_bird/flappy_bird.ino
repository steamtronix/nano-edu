...
const char STR_LOADSCREEN_CREATOR[] = "STEAMTRONIX NANO";
const char STR_LOADSCREEN_APP_NAME_LINE1[] = "Flappy";
const char STR_LOADSCREEN_APP_NAME_LINE2[] = "Bird!";
const char STR_PRESS_FLAP_TO_PLAY[] = "Press SW1 to play";
const char STR_GAME_OVER[] = "Game Over!";

// Define I/O pins
const int FLAP_BUTTON_INPUT_PIN = 2;
...
const int LOAD_SCREEN_SHOW_MS = 1500;
